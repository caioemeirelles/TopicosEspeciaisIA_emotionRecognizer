...
def preprocessdata(path,res,test_rate):
    ...
    path_train, path_test, res_train, res_test = train_test_split(path, res, test_size = test_rate,random_state=0)
...
def main(model,path_train,res_train):
...
for i in range(2):
    path_train_part = path_train[i*500:i*500+500]
    res_train_part = res_train[i*500:i*500+500]
    main(model,path_train_part,res_train_part)
